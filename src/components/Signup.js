          ...
          <div className="w-full max-w-sm space-y-8">
            ...
            <div className="space-y-6">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button disabled={submitting || Object.values(errors).some(Boolean) || !fullName || !email || !password} className="w-full h-12 bg-black text-white hover:bg-gray-800 rounded-full font-semibold text-base transition-colors duration-200">
