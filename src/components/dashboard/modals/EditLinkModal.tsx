...
export default function EditLinkModal({ isOpen, onClose, onSave, link }: EditLinkModalProps) {
  ...
  const handleSave = () => {
    if (selectedPlatform && linkUrl && linkTitle && link) {
      ...
      <DialogContent className="sm:max-w-[425px] p-0 overflow-hidden">
        <AnimatePresence mode="wait">
          {step === 'selectIcon' && (
            ...
            >
              <DialogHeader className="mb-4">
                <DialogTitle className="text-2xl font-bold">Edit Social Link</DialogTitle>
              ...
              <div className="grid grid-cols-3 gap-4 max-h-80 overflow-y-auto pr-2">
                {filteredPlatforms.map(platform => (
                  ...
                  >
                    <platform.icon className="w-8 h-8 mb-2" style={{ color: platform.color }} />
          ...
          {step === 'enterUrl' && selectedPlatform && (
            ...
            >
              <DialogHeader className="mb-4">
                <DialogTitle className="text-2xl font-bold">Edit {selectedPlatform.name} Link</DialogTitle>
                <DialogDescription>Update your {selectedPlatform.name} link details.</DialogDescription>
              </DialogHeader>
