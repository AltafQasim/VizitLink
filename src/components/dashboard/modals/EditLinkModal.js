      ...
      <DialogContent className="p-0 overflow-hidden">
        <DialogHeader className="px-6 py-4 border-b border-gray-200">
          <DialogTitle className="text-xl font-semibold">
            {step === 'selectIcon' ? 'Change Platform' : 'Edit Link'}
          </DialogTitle>
          <DialogDescription>
            {step === 'selectIcon' 
              ? 'Choose a different social media platform'
                  ...
                  {filteredPlatforms.map((platform) => {
                    ...
                    return (
                      <button
                        ...
                        className={`flex flex-col items-center p-3 rounded-lg border transition-colors group ${
                          isSelected 
              ...
              >
                ...
                <div className="flex items-center space-x-3 p-4 bg-gray-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Update your link details</p>
                  </div>
                </div>
